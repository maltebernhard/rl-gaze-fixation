...
def create_mixture(model_type, mixture_mode):
    ...
    obstacle_evasion.env.set_next_env(gaze_fixation1.env)
    ...
    target_following.env.set_next_env(gaze_fixation2.env)
    ...
    gaze_fixation1.env.set_next_env(moe.env)
    gaze_fixation2.env.set_next_env(moe.env)
    moe.env.set_next_env(base_env)
